...
export const AdminSidebar: React.FC<SidebarProps> = memo(({ 
  ...
  const navItems: NavItem[] = useMemo(() => [
    ...
    // Templates handled by SidebarTemplatesCollapse
    {
      title: t('sidebar.colleges', 'Colleges'),
      href: "/dashboard/admin/colleges",
      icon: Building2,
      badge: MOCK_COLLEGES_COUNT,
      badgeColor: "bg-purple-500",
      description: t('sidebar.collegesDesc', 'Institution management'),
    },
    {
      title: t('sidebar.reports', 'Reports'),
      href: "/dashboard/admin/analytics",
      icon: BarChart3,
      description: t('sidebar.reportsDesc', 'Analytics & insights'),
    },
    {
          ...
          <div className="space-y-2 px-2 mb-4">
            ...
            <div className="flex items-center justify-between text-xs">
              <span className="text-muted-foreground flex items-center gap-1">
                ...
                {t('sidebar.totalResponses', 'Total Responses')}
              </span>
              <span className="font-medium text-amber-600">1,284</span>
            </div>
          </div>
        )}
