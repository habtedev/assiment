        ...
        <Card className="border-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm shadow-xl">
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-gradient-to-br from-amber-50 to-rose-50 dark:from-amber-950/30 dark:to-rose-950/30">
            ...
            <div>
              <h4 className="font-semibold mb-3">Recent Colleges</h4>
              <div className="space-y-3">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="flex items-center justify-between p-2 rounded-lg hover:bg-muted/50">
                    <div className="flex items-center gap-3">
                      <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-amber-400 to-rose-500 flex items-center justify-center text-white text-xs">
                        {i === 1 ? "CI" : i === 2 ? "CM" : "CB"}
                      </div>
                      <div>
                        <p className="text-sm font-medium">
                          {i === 1 ? "College of Informatics" : 
                           i === 2 ? "College of Medicine" :
                           "College of Business"}
                        </p>
